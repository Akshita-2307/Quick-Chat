# Quick Chat
It is a dynamic web-based chat application made using HTML,CSS and Javascript.
It allows user to create their profile,view others profile,send messages, delete messages in a clean and responsive way.
